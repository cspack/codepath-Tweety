...
/**
 * Source: https://github.com/saulmm/CoordinatorBehaviorExample
 */
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
  ...
  public AvatarImageBehavior(Context context, AttributeSet attrs) {
    ...
    if (attrs != null) {
      ...
      mCustomStartToolbarPosition = a.getDimension(
          R.styleable.AvatarImageBehavior_startToolbarPosition, 0);
    ...
    mFinalLeftAvatarPadding = context.getResources().getDimension(R.dimen.avatar_spacing);
  }
  ...
  private void bindDimensions() {
    mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.avatar_width);
  }
